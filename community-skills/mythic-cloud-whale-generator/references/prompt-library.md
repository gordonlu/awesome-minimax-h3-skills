...
```text
Epic cinematic film still, 16:9 wide composition. A colossal mythological whale half-submerged in an endless sea of golden clouds at dusk, occupying the right third of the frame in side profile, slightly angled toward the camera so both its head and the curve of its back are readable. Its body is a drifting rock-island: weathered basalt cliffs, carpets of dark moss and hanging vines, small waterfalls spilling off its flanks into the clouds, ancient stone strata running along its spine, and faint star-like lights glinting between its giant scales. The whale's eye, half-visible, is a deep amber fissure with moss growing in its corners. The left two-thirds of the frame: a rolling sea of clouds glowing like molten gold, textured with slow billowing volumes, a few cloud peaks breaking the surface in the far distance for scale. Three volumetric sun shafts break through gaps in the cloud ceiling, dust motes and cloud droplets glittering inside the beams. Light: warm golden-hour key light from upper left, cool blue shadow fill from below the cloud deck, rim light tracing the whale's spine and cliff edges. Color grading: rich golden amber dominant, deep teal shadows, high dynamic range. Quality: photorealistic, hyper-detailed surface texture, physically plausible cloud rendering, epic scale contrast with tiny distant birds for scale, film grain, shot on large-format cinema camera, 35mm equivalent depth of field, cinematic color grade.
```
