...
[Shot 1] The target video is an epic war-sequence in photorealistic style, scorched-gold dusk over a dust-scoured plain, matching the composition, riders and lighting of <Picture 1> at 0.00 seconds. From 0.00 to 1.40 seconds, the cavalry surges forward at full gallop, natural real-time speed, hooves hammering the ground and kicking sand-spray plumes behind every stride; the low camera keeps level with the ground and accelerates into a side chase, the lens locking the front rank in crisp focus as the plain streaks past. From 1.40 to 3.20 seconds, the riders press low over their horses, lance-tips cutting through the hanging dust haze, sand glowing gold in the low backlight; rim-lit helmets and armor wear flash as the rank surges, the camera matching their speed at the same height. From 3.20 to 4.80 seconds, the trailing dust wall churns behind the column, only light sand spray washing past the lens, banners snapping in the wind; the camera holds its ground-level lateral course, the front rank staying in sharp focus throughout. From 4.80 to 6.20 seconds, at the peak the front rank surges past the lens on the same plane, and the trailing dust wall swallows the frame from behind. From 6.20 to 7.00 seconds, the camera eases backward along the ground, staying level with the plain, as the charge streams away and its dust trail sweeps past the lens; the shot ends wide and low, dust settling in fading golden light.
