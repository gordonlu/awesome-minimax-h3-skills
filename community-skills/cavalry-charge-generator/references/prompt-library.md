...
[Shot 1] The target video is an epic war-sequence in photorealistic style, scorched-gold dusk over a dust-scoured plain, matching the composition, riders and lighting of <Picture 1> at 0.00 seconds; the horses stay fully grounded from first frame to last, every stride landing on the sand. From 0.00 to 1.40 seconds, a wide low establishing shot: the lens skims the sand so low that coarse foreground grain streaks past the bottom of the frame, pinning the speed to the ground, as the cavalry emerges from the distant haze line at full gallop, natural real-time speed, hooves visibly striking and digging into the sand with every stride, each contact kicking a distinct puff of dust, the dust wall churning behind the column on the horizon; the camera drifts laterally at ground level, letting the charge grow in the frame. From 1.40 to 2.80 seconds, the camera sprints into a side chase at saddle height with a handheld jolt, shaking with the hoofbeats, the lens locking the riders in crisp focus; the horses gallop in full power strides, driving into the sand, long shadows streaming behind them in the low golden light, lance-tips cutting through the hanging dust haze. From 2.80 to 4.20 seconds, the leading riders surge past the lens and a veil of dust washes across it; the camera comes out low ahead of the column at ankle height, and the front rank thunders straight at the lens, each hoof-strike throwing sand into silhouette against the low sun, growing to fill the frame. From 4.20 to 5.60 seconds, at the peak the horses launch past the lens on both sides at full stride, sand kicking off every hoof-strike as they split around the camera, and the trailing dust wall swallows the frame from behind. From 5.60 to 7.00 seconds, the dust clears; the camera holds low behind the charge as the column streams away into the haze, hoofbeats fading, the trailing dust wall receding with it, ending on a wide low shot of the charge fading into the golden dusk.
...
**验收**：首秒与参考图同构图同质感；全速真实时间、无主体慢镜；越镜吞镜为唯一峰值；金色逆光剪影；至少两层尘参与响应；结尾低机位身后收束、无垂直运镜；全程接地（蹄落沙+溅尘+前景滚动+手持抖动），无漂浮感、无滑行、无镜头切换、无文字、无宫格。
...
```text
integrated_multimodal_description: [Shot 1] 00:00.0-00:07.0 Scorched-gold dusk over a dust-scoured plain; the camera skims the sand on a low fast dolly-in, coarse grain streaking past the bottom of the frame, a rolling dust wall on the horizon. 00:00.8-00:02.6 A cavalry mass appears at the dust line and charges at full gallop, natural real-time speed, hooves visibly striking the sand, each contact kicking a distinct puff of dust, long shadows streaming behind; the camera drifts laterally, letting the charge grow in the frame. 00:02.6-00:04.8 The camera sprints into a side chase at saddle height with a handheld jolt, shaking with the hoofbeats, riders locked in crisp focus, hooves digging into the sand, lance-tips cutting through the hanging dust haze, sand glowing gold in the low backlight, metal clatter and banner cloth tearing in the wind. 00:04.8-00:06.2 At the peak the front rank surges past the lens and the trailing dust wall swallows the frame from behind. 00:06.2-00:07.0 The dust clears; the camera holds low behind the charge as it streams away into the haze, dust settling in fading golden light.
...
**验收**：首秒低机位贴沙推进 + 尘线可见；全速狂奔真实速度、无主体慢镜；越镜为唯一峰值；金逆光剪影；至少两层尘参与响应；结尾低机位身后收束、无垂直运镜；全程接地（蹄落沙+溅尘+前景滚动+手持抖动），无漂浮感、无滑行、无镜头切换、无文字、无宫格。
